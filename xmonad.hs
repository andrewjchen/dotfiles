...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  --, ((modMask .|. shiftMask, xK_s     ), withFocused (keysAbsResizeWindow (10,10) (1024,752)))
    ...
    , ((modMask                         , xK_F7         ), spawn "mplayer /home/ajc/git/dotfiles/sounds/elevatorstuck.mp3")
    , ((modMask                         , xK_F8         ), spawn "mplayer /home/ajc/git/dotfiles/sounds/wakeup.mp3")
    , ((modMask                         , xK_F9         ), spawn "mplayer /home/ajc/git/dotfiles/sounds/slinky.flv")
    , ((modMask                         , xK_F10        ), spawn "mplayer /home/ajc/git/dotfiles/sounds/petman.flv")
